function validateFname() {
  ...
  if (!fname.match(/^[a-zA-Z]+$/)) {
    fnameError.textContent = "Invalid First Name. Only letters allowed.";
  } else {
...
function validateLname() {
  ...
  if (!lname.match(/^[a-zA-Z]+$/)) {
    lnameError.textContent = "Invalid Last Name. Only letters allowed.";
  } else {
...
function validateEmail() {
  ...
  var pat = /^[^ ]+@[^ ]+\.[a-z]{2,3}$/;
  if (!email.match(pat)) {
    emailError.textContent = "Invalid email.Use the format aaa@example.com ";
  } else {
...
function changeOption() {
  ...
  if (l1.value === "1") {
    l2.innerHTML = 
  "<option>Information Management</option><option>Networking</option><option>Software Engineering</option>";
  } else if (l1.value === "2") {
    l2.innerHTML =
  "<option>Accounting</option><option>Finance</option><option>Marketing</option>";
  } else if (l1.value === "3") {
    l2.innerHTML =
  "<option>Accounting & IT</option><option>English & French</option><option>Economics & Marketing</option>";
  }
else{
